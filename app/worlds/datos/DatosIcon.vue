...
// Componente de Iconografía Minimalista Lineal — Sistema DATOS
// Vectores SVG limpios, stroke-only (1.5px), fill=none, sin emojis.
...
<template>
  ...
  >
    ...
    <!-- Academia / Educación / Harvard -->
    <template v-else-if="name === 'academic'">
